...
// Positron detector
#define CFG_CHANNEL_POS_CP2 24//16
#define CFG_CHANNEL_POS_U1_S 25//17
#define CFG_CHANNEL_POS_U2_S 26//18
#define CFG_CHANNEL_POS_V1_S 27//19
#define CFG_CHANNEL_POS_V2_S 28//20
#define CFG_CHANNEL_POS_W1_S 29//21
#define CFG_CHANNEL_POS_W2_S 30//22
// Electron detector
#define CFG_CHANNEL_ELEC_CP2 16//24
#define CFG_CHANNEL_ELEC_U1_S 21//27
#define CFG_CHANNEL_ELEC_U2_S 18//28
#define CFG_CHANNEL_ELEC_V1_S 19//25
#define CFG_CHANNEL_ELEC_V2_S 20//26
#define CFG_CHANNEL_ELEC_W1_S 17//29
#define CFG_CHANNEL_ELEC_W2_S 22//30
